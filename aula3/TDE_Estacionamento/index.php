...
//     public function __construst(string $nome, string $raca)
//     {
//         $this->nome = $nome;
//         $this->raca = $raca;
//     }
...
//$dog = new Cachorro(raca: "Dasch", nome: "Nome");
...
class Historico {
    ...
    public function __construct(){
        ...
        $this->dataSaida = DateTime::createFromFormat("d/m/Y H:i:s", "22/08/2024 21:18:30");
        $this->vaga = new Vaga();
